...
namespace RecipeBox.Controllers
{
  ...
  public class RecipesController : Controller
  {
    ...
    public async Task<ActionResult> Index()
    {
      ...
      //This is called an existential operator. It states that we should only call the property to the right of the ? if the method to the left of the ? doesn't return null.
